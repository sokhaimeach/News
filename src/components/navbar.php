...
<nav id="navbar" class="w-full top-0 flex flex-col fixed z-50 left-0 transition-all duration-300">
    <!-- navbar -->
    <nav class="w-full relative z-50 bg-red-700 h-[65px] px-4 md:px-6 flex items-center justify-between">
        <!-- mobile menu -->
        <div class="sm:hidden">
    ...
    <div id="ticker" class="w-full relative z-40 bg-red-800">
